...
# Load the JSON file
with open('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/segmentation_v2/train_with_scheduling_with_z.json', 'r') as file:
    data = json.load(file)

# Directory containing the CSV files
csv_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/train/xy_centers'
