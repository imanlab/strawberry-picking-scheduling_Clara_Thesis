...
#Add xy centers coordinates to the json file with all the strawberries

# Load the JSON file
with open('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/test_with_scheduling_with_z.json', 'r') as file:
    data = json.load(file)

# Directory containing the CSV files
csv_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test/xy_centers'
            ...
            for row in reader:
                ...
                if len(row) >= 3: 
                    ...
                    try:
                        ...
                        y_int = round(y)
                        z_int = round(z)
                        checj = len(data[json_key]['regions'])
                        print(checj)
...
output_json_path = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/test_with_scheduling_with_z_with_centers.json' # Replace with your desired output JSON file path
