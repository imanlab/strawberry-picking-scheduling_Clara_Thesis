...
#Add z coordinates to the json file

# Load the JSON file
with open('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/segmentation_v2/test _with_scheduling.json', 'r') as file:
    data = json.load(file)
    print(data)

# Directory containing the CSV files
csv_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/z_poligons'
...
output_json_path = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/segmentation_v2/test_with_scheduling_with_z.json'  # Replace with your desired output JSON file path
