...
def add_z_coordinates():
   file_path = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/train/xy_centers"
   ...
   for file in files:
       ...
       z_file = f"/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/train/z_extraction/avg_{base_name}.txt"
       print(z_file)
