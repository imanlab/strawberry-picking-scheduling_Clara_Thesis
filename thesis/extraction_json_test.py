...
# Load CSV file
data = pd.read_csv('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/test.csv')

# Specify directory to save images
directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/single_test_seg2_data_annotation'
...
image_files = os.listdir('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test')
...
for image_file in image_files:
    ...
    image_path = os.path.join('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test', image_file)
