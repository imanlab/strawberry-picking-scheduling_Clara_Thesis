...
original_folder_path = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/val/optimal_fin'
# Define the folder path where you want to save the modified CSV files
new_folder_path = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/val/final_scheduling_annotations_allrows'
