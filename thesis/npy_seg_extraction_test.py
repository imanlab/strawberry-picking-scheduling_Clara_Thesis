...
#To extract the single npy from each strawberry

# Load the JSON file
json_file = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/test.json" # Replace with your .json file path
with open(json_file, 'r') as f:
 data = json.load(f)

# Get the list of all .npy files in the directory
npy_folder = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test_npy" # Replace with your .npy folder path
npy_files = [f for f in os.listdir(npy_folder) if f.endswith('.npy')]
print(npy_files)

# Create a new folder for the new .npy files
new_folder = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/npy_seg" # Replace with your new .npy folder path
