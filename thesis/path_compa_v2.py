...
predicted_directories = [
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/train/final_scheduling_annotations_allrows_ga', 
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test/final_scheduling_annotations_allrows_ga', 
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/val/final_scheduling_annotations_allrows_ga', 
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/train/final_scheduling_annotations_allrows_ga', 
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/final_scheduling_annotations_allrows_ga', 
    '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/val/final_scheduling_annotations_allrows_ga'
]
...
output_csv_file = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/compa_paths_k_g/normalized_error_results.csv'
base_output_plots_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/compa_paths_k_g'
    ...
    try:
        ...
        for filename, (ground_truth_file, predicted_file) in associations.items():
            try:
                ...
                total_length_errors = [abs(gt - pred) / pred for gt, pred in zip(ground_truth_total_length_all, predicted_total_length_all)]
                ...
                scheduling_order_errors = [abs(gt - pred) / pred for gt, pred in zip(ground_truth_scheduling_order_all, predicted_scheduling_order_all)]
                ...
                print(f"Mean Scheduling Order Error for {filename}: {mean_scheduling_order_error}\n")
                ...
                plt.plot(indices, predicted_total_length_first, label='GA', color='orange', marker='x')
                plt.xlabel('Index')
                plt.ylabel('Total Length')
                plt.title(f'Total Lengths: Kmeans VS GA for {filename}', fontsize=16)
                plt.legend()
                plt.grid(True)
                ...
                plt.plot(indices, predicted_scheduling_order_first, label='GA ', color='orange', marker='x')
                plt.xlabel('Index')
                plt.ylabel('Scheduling Order')
                plt.title(f'Scheduling Orders: Kmeans VS GA  for {filename}', fontsize=16)
                plt.legend()
                plt.grid(True)
                ...
                plt.plot(indices, predicted_total_length_all[:num_rows], label='GA ', color='orange', marker='x')
                plt.xlabel('Index')
                plt.ylabel('Total Length')
                plt.title(f'Total Lengths (First {num_rows} Rows): Kmeans VS GA for {filename}', fontsize=16)
                plt.legend()
                plt.grid(True)
                ...
                plt.plot(indices, predicted_scheduling_order_all[:num_rows], label='GA', color='orange', marker='x')
                plt.xlabel('Index')
                plt.ylabel('Scheduling Order')
                plt.title(f'Scheduling Orders (First {num_rows} Rows): Kmeans VS GA for {filename}', fontsize=16)
                plt.legend()
                plt.grid(True)
...
plt.subplot(2, 1, 1)
plt.scatter(combined_indices, combined_ground_truth_total_lengths, label='K means', color='blue', marker='o', alpha=0.7)
plt.scatter(combined_indices, combined_predicted_total_lengths, label='GA', color='orange', marker='x', alpha=0.7)
plt.axhline(y=average_ground_truth_total_length, color='blue', linestyle='--', linewidth=5, label='Avg K means Total Length')
plt.axhline(y=average_predicted_total_length, color='orange', linestyle='--', linewidth=5, label='Avg GA Total Length')
plt.xlabel('Index')
plt.ylabel('Total Length')
plt.title('Total Lengths: Kmeans VS GA', fontsize=18)
plt.legend()
plt.grid(True)
...
plt.subplot(2, 1, 2)
plt.scatter(combined_indices, combined_ground_truth_scheduling_orders, label='K means', color='blue', marker='o', alpha=0.7)
plt.scatter(combined_indices, combined_predicted_scheduling_orders, label='GA', color='orange', marker='x', alpha=0.7)
plt.axhline(y=average_ground_truth_scheduling_order, color='blue', linestyle='--', linewidth=5, label='Avg K means Scheduling Order')
plt.axhline(y=average_predicted_scheduling_order, color='orange', linestyle='--', linewidth=5, label='Avg GA Scheduling Order')
plt.xlabel('Index')
plt.ylabel('Scheduling Order')
plt.title('Scheduling Orders: Kmeans VS GA' , fontsize=18)
plt.legend()
plt.grid(True)

plt.tight_layout()
combined_plot_filename = os.path.join(base_output_plots_directory, 'combined_plot_k_g.png')
