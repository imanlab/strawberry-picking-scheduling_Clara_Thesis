...
def main():
    ...
    directory2 = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/train/coordinates_and_hop'  # Change this to the path to your second folder of CSV files
