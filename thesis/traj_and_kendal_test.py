...
#Compute Hardness of Picking cost function and add it to the csv with the best ten path

# Directory containing the CSV files
input_csv_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test/optimal_path_astar'

# Directory containing the JSON files
json_base_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/segmentation2_data/single_test_seg2_data_annotation'

# Output directory for the CSV files
output_csv_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling/scheduling_data_collection/data-collection/test/optimal_fin_astar'
...
def process_row(row, image_number):
    ...
    # Check if nodes is a single integer and convert it to a list if so
