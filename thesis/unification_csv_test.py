...
#Take the csv files with the xy centers and add the z coordinate (check if it's true)
...
directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/xy_centers'
output_directory = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/coordinates_for_images'
