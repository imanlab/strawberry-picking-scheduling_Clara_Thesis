...
with open('/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/segmentation_v2/test.json', 'r') as f:
 annotations = json.load(f)

image_dir = '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test'

centroid_dir = os.path.join(image_dir, '/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/xy_centers')
