...
# Load the JSON file
json_file = "//home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/segmentation_v2/test.json"
with open(json_file, 'r') as f:
 data = json.load(f)

# Get the list of all .npy files in the directory
npy_folder = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test_npy" # Replace with your .npy folder path
...
avg_folder = "/home/clara/Thesis/strawberry-pp-w-r-dataset-master/scheduling_riseholme/test/z_extractionn" # Replace with your avg folder path
